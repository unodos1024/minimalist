const translations = {
    ko: {
        ...
        type_reflection: "성찰", type_pause: "멈춤", type_journey: "여정", type_clearance: "비움", day_count: "일차",
    ...
    en: {
        ...
        type_reflection: "Reflection", type_pause: "Pause", type_journey: "Journey", type_clearance: "Clearance", day_count: "Day ",
    ...
    fr: {
        ...
        type_reflection: "Réflexion", type_pause: "Pause", type_journey: "Voyage", type_clearance: "Vide", day_count: "Jour ",
    ...
    es: {
        ...
        type_reflection: "Reflexión", type_pause: "Pausa", type_journey: "Viaje", type_clearance: "Limpieza", day_count: "Día ",
...
function loadJourney() {
    ...
    const dayLabel = (state.lang === 'ko' || state.lang === 'ja') ? displayDay + t.day_count : t.day_count + displayDay;
    document.getElementById('journey-day-label').textContent = dayLabel;

    const card = document.getElementById('journey-card');
    const text = document.getElementById('journey-text');

    if (challenge) {
        text.textContent = challenge[state.lang] || challenge.en;
    } else {
        text.textContent = "...";
    }
...
function completeJourney() {
    ...
    const content = challenge[state.lang] || challenge.en;
    const dayLabel = (state.lang === 'ko' || state.lang === 'ja') ? currentDay + translations[state.lang].day_count : translations[state.lang].day_count + currentDay;
